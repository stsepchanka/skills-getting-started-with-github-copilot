...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill development and friendly scrimmages for all skill levels",
    ...
    "Debate Team": {
        "description": "Practice formal debates and attend inter-school competitions",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["sophia.r@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Problem solving sessions and preparation for math contests",
